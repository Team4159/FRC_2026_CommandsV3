    ...
    public static Command cmd(Shooter shooter, Hood hood, Neck neck, Intake intake, Hopper hopper){
        ...
        return Command.noRequirements(
            coroutine -> {
                ...
                coroutine.fork(shooter.changeVelocity(ShooterConstants.hubAngularVelocity));
                coroutine.fork(hood.changeTrajectoryAngle(HoodConstants.hubHoodPitch));
